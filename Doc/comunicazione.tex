...
\subsection{Il Protocollo di Comunicazione}
	...
	Il protocollo di comunicazione è molto semplice: la struttura statica del gioco ha permesso la definizione di un protocollo rigido. I messaggi vengono scambiati solo tra giocatori di ruoli diversi, in particolare tra i Kids e la Witch: questo spiega la scelta di collegamenti punto-punto delle socket.
