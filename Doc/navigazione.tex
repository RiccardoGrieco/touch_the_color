Per la navigazione dei robot, in particolare del robot \textit{Kid}, è stato utilizzato un approccio misto che utilizza sussunzione e metodologia a campi di potenziale.
...
\subsection{Campi di potenziale}
	...
	Il campo viene percepito solo quando la distanza dall'oggetto è di almeno 1 metro e solo se rilevato dagli otto sonar anteriori (0-7).
...
\subsection{Orientamento}
	...
	Un problema che sorge dall'utilizzo di questo sistema è quello della gestione dei punti di cui non si hanno più rilevazioni dai sensori. Nel caso specifico del robot Kid, se esso non ha più visibilità del POI che cerca di raggiungere, ad esempio perché si è dovuto girare per evitare un'ostacolo, deve comunque poter stimare la posizione dell'oggetto.
...
\subsection{Movimento}
	...
	\begin{center}
		$\omega = \frac{F_x}{3.5}$
	\end{center}
	In questo modo la velocità lineare massima raggiunta è di $0.25$ $m/s$ mentre quella angolare assume un valore massimo di $0.8976$ $rad/s$ ($51.42°/s$).
